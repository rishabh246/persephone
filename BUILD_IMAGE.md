...
sudo ${PSP_DIR}/Persephone/scripts/setup/pick_kernel.sh 4.4.0-187-generic
```
...
```bash
git clone --recurse-submodules https://github.com/maxdml/psp.git ${PSP_DIR}/client
cd ${PSP_DIR}/client
git checkout client
mkdir ${PSP_DIR}/client/build
cd ${PSP_DIR}/client/build
cmake -DCMAKE_BUILD_TYPE=Release -DDPDK_MELLANOX_SUPPORT=OFF ${PSP_DIR}/client
make -j -C ${PSP_DIR}/client/build
```
